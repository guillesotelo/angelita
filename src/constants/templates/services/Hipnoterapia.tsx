...
export default function Hipnoterapia({ checkout }: Props) {
    return (
        <div className="service-template__container">
            <h2 className="service-template__title">Hipnoterapia</h2>
            <div className="service-template__section">
                ...
                <div className="service-template__col2">
                    ...
                    <div className="service-template__row" style={{ transform: 'scale(.85)' }}>
                        <h4 className="service-template__prices-detail">Sesión de 90 minutos</h4>
                        <div className="service-template__prices">
                            <h4 className="service-template__prices-text"><strong>US $60</strong></h4>
                        </div>
                    </div>
                    <button className="service-template__btn" onClick={() => checkout('6544fef7dbbd5e4ec1196698')}>Reservar</button>
                </div>
            </div>
        </div>
    )
